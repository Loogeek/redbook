...
import iconDailyImg from "@/assets/images/icon_daily.png";
import iconSearchImg from "@/assets/images/icon_search.png";
  ...
  return (
    <View style={styles.titleLayout}>
      <TouchableOpacity style={styles.dailyButton}>
        <Image style={styles.icon} source={iconDailyImg} />
      </TouchableOpacity>
      ...
      <TouchableOpacity style={styles.searchButton}>
        <Image style={styles.icon} source={iconSearchImg} />
      </TouchableOpacity>
    </View>
  );
}
